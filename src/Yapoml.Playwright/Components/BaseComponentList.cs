...
namespace Yapoml.Playwright.Components
{
        ...
        where TComponentConditions : BaseComponentConditions<TComponentConditions>
    {
        ...
        public BaseComponentList(BasePage page, BaseComponent parentComponent, IPage context, IElementsListHandler elementsListHandler, ComponentsListMetadata componentsListMetadata, IEventSource eventSource, ISpaceOptions spaceOptions)
        {
            _page = page;
