...
[assembly: InternalsVisibleTo("Yapoml.Playwright.Test")]
[assembly: InternalsVisibleTo("Yapoml.Playwright.Benchmark")]
...
namespace Yapoml.Playwright.SourceGeneration
{
    ...
    internal class Generator : IIncrementalGenerator
    {
        ...
        private static Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            ...
            {
                resourceName = "Yapoml.Playwright.SourceGeneration.YamlDotNet.dll";
            }
            else if (args.Name.StartsWith("Scriban"))
            {
                resourceName = "Yapoml.Playwright.SourceGeneration.Scriban.dll";
            }
            else if (args.Name.StartsWith("Humanizer"))
            {
                resourceName = "Yapoml.Playwright.SourceGeneration.Humanizer.dll";
            }
            else if (args.Name.StartsWith("Yapoml.Framework.Workspace"))
            {
                resourceName = "Yapoml.Playwright.SourceGeneration.Yapoml.Framework.Workspace.dll";
            }
