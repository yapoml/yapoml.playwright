...
namespace Yapoml.Playwright.Components.Conditions
{
    ...
    public class UrlPathConditions<TConditions> : TextualConditions<TConditions>
    {
        ...
        public UrlPathConditions(IPage context, TConditions conditions, TimeSpan timeout, TimeSpan pollingInterval, PageMetadata pageMetadata, ILogger logger)
        ...
        protected override Func<string> FetchValueFunc => () => new Uri(_context.Url).AbsolutePath;
