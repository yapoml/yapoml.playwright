...
namespace Yapoml.Playwright.SourceGeneration.Services
{
    internal class GenerationService : ScriptObject
    {
        ...
        {
            return _returnTypesCache.GetOrAdd(component, c =>
            {
                return $"{c.SingularName}Component";
            });
        }
        ...
        {
            return _returnFullTypesCache.GetOrAdd(component, c =>
            {
                return $"global::{component.Namespace}.{component.SingularName}Component";
            });
        }
